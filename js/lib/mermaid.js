...
const mermaidConfig = {"cdn":"","fontfamily":"","layout":"dagre","layoutloaders":[],"look":"handDrawn","securitylevel":"loose","themes":["default","dark"],"zenuml":"","zoom":{"enable":true}}
...
async function initMermaid() {
  ...
  runWhenIdle(() => {
    loadMermaid({ theme: 'neutral', darkMode: false, selector: '.mermaid-neutral', watchViewport: true })
  })
}
