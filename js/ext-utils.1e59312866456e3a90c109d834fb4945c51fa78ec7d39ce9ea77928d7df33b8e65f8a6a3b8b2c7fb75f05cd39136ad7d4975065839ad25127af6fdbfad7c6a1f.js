...
class TranslationPlugin {
    ...
    init(){
        document.addEventListener('DOMContentLoaded', () => {
            this.loadTranslationScript(thils.initTranslation);
        })
    }
}
...
(() => {
    ...
    //     if (!ExtUtils.isMobileDevice()) {
    //         window.translationPlugin = new TranslationPlugin();
    //         window.translationPlugin.loadTranslationScript(() => {
    //             window.translationPlugin.initTranslation();
    //         });
    //     }
    // });
