"use strict";
(() => {
  // ns-hugo-imp:/home/cxd/Projects/notes/themes/FixIt-dev/assets/js/utils/common.js
  ...
  // ns-hugo-imp:/home/cxd/Projects/notes/themes/FixIt-dev/assets/js/lib/file-tree.js
  var FileTree = class {
  ...
  var FixIt = class {
    constructor() {
      ...
      this.maskOverlays = /* @__PURE__ */ new Map();
    ...
    initCodeTabs() {
      ...
      this._codeTabToggleRegistry = this._codeTabToggleRegistry || /* @__PURE__ */ new Map();
      forEach($codeBlocks, ($block) => {
        ...
        toggleLangToIndex.forEach((_index, lang) => {
          const handlers = this._codeTabToggleRegistry.get(lang) || /* @__PURE__ */ new Set();
    ...
    initLinkGuardDialog(target = document) {
      ...
      forEach(target.querySelectorAll('a[target="_blank"][data-guard="modal"]:not([data-init])'), ($link) => {
        ...
        $link.addEventListener("click", (e) => {
          e.preventDefault();
          let target2 = $link.href;
          try {
            const guardUrl = new URL($link.href);
            target2 = guardUrl.searchParams.get("target") || target2;
          } catch (err) {
          }
          dialog._target = target2;
          if ($target) {
            $target.textContent = target2;
          }
          dialog.showModal();
          document.activeElement?.blur();
        }, false);
